...
import com.hjq.demo.opendanmu.opendanmuActivity;
...
public class TestFragmentC extends MyLazyFragment
    ...
    public opendanmuActivity opendanmuActivity;
    ...
    public void onClick(View v) {
        if (v == mToastView) {
            ...
            Intent intent=new Intent(getActivity(),com.hjq.demo.opendanmu.opendanmuActivity.class);
